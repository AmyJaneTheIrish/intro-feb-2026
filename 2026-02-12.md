...
- Cohesion: "How well things go together"
    ...
    # Code Kata
    - What is it? ?? ?? Test driven, but I don't really know :o
    - Practicing this over and over to shove that into long term memory 

    - It ISN'T about getting it done
    - Writing JUST ENOUGH code to get to green 
    - When you get the next requirement
        - Should not pass
        - Be maliciously obedient, WHAT IS THE LEAST I CAN DO TO GET CREDIT
    
    

    "Another Israeli guy, they're good at unit testing idk"

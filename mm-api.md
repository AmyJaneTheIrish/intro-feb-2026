...
1. Get out of the 404
    - If it is good, something in the range of 200-299
    - If the user made a bad request, those are 400-499
        - If you don't have an authorization header that we trsut, 401
        - If i know who you are (you are authenticated), but, you CANNOT do this, not authorized - 403
        - 400 - You screwed up, wah wah `:(`
            - General bad request

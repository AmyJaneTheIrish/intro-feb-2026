...
namespace MuddiestMoment.Api.Student.Endpoints;
    ...
    public static class StudentAddsMoment
    {
            ...
            StudentMomentCreateModel request, IDocumentSession session)
        {
            ...
            // Will vary depending on waht libary/db you are using
            session.Store(entity);  // this line doesn't do any actual work. This connection running this code wants to as part of this operation, store this entity
